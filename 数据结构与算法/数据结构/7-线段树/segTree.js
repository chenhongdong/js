...
SegTree.prototype.buildSegmentTree = function (treeIndex, l, r) {
    if (l === r) {
...
SegTree.prototype.getSize = function () {
    return this.data.length;
};
SegTree.prototype.get = function (index) {
    if (index > 0 && index <= this.data.length) {
        return this.data[index];
    }
};
SegTree.prototype.leftChild = function (index) {
    return 2 * index + 1;
};
SegTree.prototype.rightChild = function (index) {
    return 2 * index + 2;
};
// 查询
SegTree.prototype.query = function (queryL, queryR) {
...
SegTree.prototype.queryRec = function (treeIndex, l, r, queryL, queryR) {
...
// 更新
SegTree.prototype.set = function (index, e) {
    if (index > 0 || index <= this.data.length) {
        this.data[index] = e;
        this.update(0, 0, this.data.length - 1, index, e);
    }
};
SegTree.prototype.update = function (treeIndex, l, r, index, e) {
    if (l === r) {
...
SegTree.prototype.toString = function () {
    var str = '';
    str += '[';
